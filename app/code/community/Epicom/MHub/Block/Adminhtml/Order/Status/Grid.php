...
class Epicom_MHub_Block_Adminhtml_Order_Status_Grid extends Mage_Adminhtml_Block_Widget_Grid
{
    public function __construct()
    {
        parent::__construct();

        $this->setId('ordersStatusesGrid');
    ...
    protected function _prepareMassaction()
    {
        ...
        $this->getMassactionBlock()->addItem('remove_orders', array(
            'label'   => Mage::helper('mhub')->__('Remove Orders Statuses'),
            'url'     => $this->getUrl('*/adminhtml_order_status/massRemove'),
