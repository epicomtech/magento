...
class Epicom_MHub_Block_Adminhtml_Attributegroup_Edit_Tabs extends Mage_Adminhtml_Block_Widget_Tabs
{
    ...
    protected function _beforeToHtml ()
    {
        $this->addTab ('attributegroup_section', array(
            ...
            'content' => $this->getLayout ()->createBlock ('mhub/adminhtml_attributegroup_edit_tab_form')->toHtml (),
        ));
