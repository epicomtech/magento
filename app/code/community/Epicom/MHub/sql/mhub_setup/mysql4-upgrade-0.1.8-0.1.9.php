...
function addMHubQuoteTable ($installer, $model, $description)
{
...
addMHubQuoteTable ($installer, Epicom_MHub_Helper_Data::QUOTE_TABLE, 'Epicom MHub Quote');
